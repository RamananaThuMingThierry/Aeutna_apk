...
class CapEst extends StatefulWidget {
  const CapEst({Key? key}) : super(key: key);

  @override
  State<CapEst> createState() => _CapEstState();
}

class _CapEstState extends State<CapEst> {
  ...
  getUsersStream() async{
    var data = await FirebaseFirestore.instance.collection("users").where("axes", isEqualTo: "Cap Est").get();
    setState(() {
