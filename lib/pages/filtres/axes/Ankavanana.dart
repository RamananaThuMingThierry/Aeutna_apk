...
class Ankavanana extends StatefulWidget {
  const Ankavanana({Key? key}) : super(key: key);

  @override
  State<Ankavanana> createState() => _AnkavananaState();
}

class _AnkavananaState extends State<Ankavanana> {
  ...
  getUsersStream() async{
    var data = await FirebaseFirestore.instance.collection("users").where("axes", isEqualTo: "Ankavanana").get();
    setState(() {
